...
// export const Toast = React.forwardRef<React.ElementRef<typeof ToastPrimitives.Root>, React.ComponentPropsWithoutRef<typeof ToastPrimitives.Root>>(
//   ({ className, ...props }, ref) => (
//     <ToastPrimitives.Root ref={ref} className={cn("bg-gray-800 text-white", className)} {...props} />
//   )
// );
...
// import { ToastProvider, Toast, ToastTitle, ToastDescription, ToastClose, ToastViewport } from "./ToastComponents"; // adapte le chemin
...
// Composants toast définis ici directement :
